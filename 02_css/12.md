...
Antes de testarmos a propriedade `align-items`, vamos **alterar a altura de cada um dos quatro elementos**. Para isso, adicionaremos a propriedade `height` com **valores diferentes**, permitindo visualizar com mais clareza como o alinhamento vertical funciona no Flexbox.

Essas alturas variadas ajudarão a perceber como os itens se comportam ao longo do **eixo cruzado** (*cross axis*) quando aplicarmos o `align-items`, conforme ilustrado no trecho de código abaixo:

<div align="center"><img src="https://i.imgur.com/XsfnKnI.png" title="source: imgur.com" /></div>
...
<div align="center"><img src="https://i.imgur.com/1y3jTN8.png" title="source: imgur.com" /></div>
